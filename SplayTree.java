...
public class SplayTree<K,E> extends SplayTreeAbstract<K,E>
{
    ...
    public void add(Palabras wordObject) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    public Palabras getx(Palabras word) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
    ...
    @Override
    public boolean containsValue(E v) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
